...
from modeling.imagebind.models.multimodal_preprocessors import SimpleTokenizer

DEFAULT_AUDIO_FRAME_SHIFT_MS = 10  # in milliseconds

BPE_PATH = '/team_code/src/modeling/imagebind/bpe_simple_vocab_16e6.txt.gz'
...
def load_and_transform_vision_data(image_paths, device):
    ...
    for image_path in image_paths:
        ...
        if not isinstance(image_path, Image.Image):
            ...
            image = image_path.convert('RGB') # case of PIL 
